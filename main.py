...
# add a User class to make all new functionality possible...from "Get It Done!" app
class User(db.Model):
...
def home():
    ...
    return render_template('home.html', title = "Blogz", blogs= blogs, welcome= welcome)
...
def AddBlog():
    ...
    if request.method == 'POST':
        ...
        if new_body == "":
            error["body_blank"] = "Enter text for your blog's body"
